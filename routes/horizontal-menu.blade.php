                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-pages">
                                    ...
                                    <a href="/chat" class="dropdown-item" data-key="t-chat"><?php echo $language["Chat"]; ?></a>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-email">
                                            <a href="/notes" class="dropdown-item" data-key="t-inbox"><?php echo $language["Inbox"]; ?></a>
                                            <a href="/notes-read" class="dropdown-item" data-key="t-read-email"><?php echo $language["Read_Email"]; ?></a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-ecommerce">
                                            <a href="/products" class="dropdown-item" data-key="t-products"><?php echo $language["Products"]; ?></a>
                                            <a href="/products/details/1" class="dropdown-item" data-key="t-product-detail"><?php echo $language["Product_Detail"]; ?></a>
                                        </div>
                                    </div>
        ...
        <div class="d-flex">
            ...
            <button type="button" class="btn header-item" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                   ...
                   <a href="?lang=br" class="dropdown-item notify-item">
                        <img src="/assets/images/flags/br.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle"> Brasil </span>
                    </a>
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    ...
                    <a class="dropdown-item" href="/chat"><i class='bx bx-chat text-muted font-size-18 align-middle me-1'></i> <span class="align-middle"><?php echo $language["Chat"]; ?></span></a>
