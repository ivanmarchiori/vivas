                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-3">
                                    ...
                                    <div class="mt-4 pt-2">
                                        ...
                                        <p class="text-muted font-size-15"><?= $language['Thankyouforusing'] ?> <span
                                                class="fw-semibold text-dark">{{ $language['NomeEmpresa'] }}</span></p>
                                        <div class="mt-4">
                                            <a href="/"
                                                class="btn btn-primary w-100 waves-effect waves-light"><?= $language['SignIn'] ?></a>
                                        </div>
                                    </div>
                                </div>
