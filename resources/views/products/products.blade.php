                                            ...
                                            <div class="product-box">
                                                ...
                                                <div class="product-content p-4">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-end">
                                                        <div>
                                                            <h5 class="mb-1"><a href="#" class="text-dark font-size-16">Nike N012 Shoes</a></h5>
                                        ...
                                        <div class="col-xl-4 col-sm-6">
                                            <div class="product-box">
                                                ...
                                                <div class="product-content p-4">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-end">
                                                        <div>
                                                            <h5 class="mb-1"><a href="#" class="text-dark font-size-16">Adidas Running Shoes</a></h5>
                                        ...
                                        <div class="col-xl-4 col-sm-6">
                                            <div class="product-box">
                                                ...
                                                <div class="product-content p-4">
                                                    <div class="d-flex justify-content-between align-items-end">
                                                        <div>
                                                            <h5 class="mb-1"><a href="#" class="text-dark font-size-16">Puma P103 Shoes</a></h5>
                                        ...
                                        <div class="col-xl-4 col-sm-6">
                                            <div class="product-box">
                                                ...
                                                <div class="product-content p-4">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-end">
                                                        <div>
                                                            <h5 class="mb-1"><a href="#" class="text-dark font-size-16">Sports S120 Shoes</a></h5>
                                        ...
                                        <div class="col-xl-4 col-sm-6">
                                            <div class="product-box">
                                                ...
                                                <div class="product-content p-4">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-end">
                                                        <div>
                                                            <h5 class="mb-1"><a href="#" class="text-dark font-size-16">Adidas AB23 Shoes</a></h5>
