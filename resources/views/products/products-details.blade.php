                                        ...
                                        <div class="col-xl-8">
                                            <div class="mt-4 mt-xl-3 ps-xl-4">
                                                ...
                                                <div class="text-muted">
                                                    <span class="badge bg-success font-size-14 me-1"><i
                                                ...
                                                <p class="mt-4 text-muted">If several languages coalesce, the grammar of
                                                    the resulting language is more simple and regular</p>
                                                ...
                                                <div>
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <h5 class="font-size-14 mb-3"><i
                                                                class="bx bx-map-pin font-size-20 text-primary align-middle me-2"></i>
                                                                ...
                                                                <ul class="list-inline">
                                                                    ...
                                                                    <li class="list-inline-item">
                                                                        <a href="#" data-bs-toggle="tooltip"
                                                                            data-bs-placement="top" title="Dark">
                                                                            <div class="product-color-item">
                                    ...
                                    <div class="mt-4 pt-3">
                                        ...
                                        <div class="border p-4 rounded">
                                            ...
                                            <div class="border-bottom py-3">
                                                ...
                                                <p class="text-muted mb-4">Sed ut perspiciatis unde omnis iste natus error
                                                    sit</p>
                                                <div class="d-flex align-items-start">
                                                    <div class="flex-grow-1">
