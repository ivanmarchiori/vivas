                                ...
                                <div class="card-body">
                                    <div class="text-center py-3">
                                        ...
                                        <div class="main-wid position-relative">
                                            ...
                                            <h3 class="text-white mb-0"> {{ $language['HomePage'] }},
                                                {{ auth()->user()->name }}</h3>

                                            <p class="text-white-50 px-4 mt-4">Maecenas nec odio et ante tincidunt tempus.
                                                Donec vitae sapien libero tincidunt.</p>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div>
                                                <div class="py-3 my-1">
                                                    <div id="mini-1" data-colors='["#C8BEAE"]'></div>
                                                </div>
                                                <ul
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div>
                                                <div class="py-3 my-1">
                                                    <div id="mini-3" data-colors='["#C8BEAE"]'></div>
                                                </div>
                                                <ul
                                                    class="list-inline d-flex justify-content-between justify-content-center mb-0">
                                                    <li class="list-inline-item"><a href=""
                                        ...
                                        <div class="col-xl-8">
                                            <div>
                                                <div id="sales-statistics"
                                                    data-colors='["#eff1f3","#eff1f3","#eff1f3","#eff1f3","#33a186","#C8BEAE","#eff1f3","#eff1f3","#eff1f3", "#eff1f3"]'
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center mt-4">
                                        <canvas class="mx-auto" id="sales-category" height="281"
                                            data-colors='["#C8BEAE","#51af98", "#4bafe1", "#B4B4B5", "#f1f3f4"]'></canvas>
                                    </div>
                                            ...
                                            <div class="table-responsive px-3" data-simplebar style="max-height: 393px;">
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><img src="/assets/images/users/<?= auth()->user()->photo ?>"
                                                                    class="avatar-sm rounded-circle " alt="..."></td>
                                                            <td>
                                                                <h6 class="font-size-15 mb-1">Sonya Henshaw</h6>
                                                                <p class="text-muted font-size-13 mb-0"><i
                                ...
                                <div class="card-body pt-1">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered align-middle table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><img src="/assets/images/flags/us.jpg" alt="user-image"
                                                ...
                                                <tr>
                                                    <td><img src="/assets/images/flags/germany.jpg" alt="user-image"
                                                ...
                                                <tr>
                                                    <td><img src="/assets/images/flags/italy.jpg" alt="user-image"
                                                ...
                                                <tr>
                                                    <td><img src="/assets/images/flags/es.jpg" alt="user-image"
                        ...
                        <div class="col-xl-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body py-xl-0">
                                    <div id="earning-item" data-colors='["#33a186","#C8BEAE"]' class="apex-chart"></div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-centered align-middle table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>3.</td>
                                                    <td><a href="javascript: void(0);" class="text-body">Latest Series
                                                            Watch OS 8</a> </td>
                                                    <td>
                                                        <i
