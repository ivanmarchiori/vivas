                            ...
                            <div class="card-body">
                                <div class="text-center py-3">
                                    ...
                                    <div class="main-wid position-relative">
                                        ...
                                        <h3 class="text-white mb-0"> {{$language['HomePage'] }}, {{auth()->user()->name}}</h3>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-xl-8">
                                        <div>
                                            <div id="sales-statistics" data-colors='["#eff1f3","#eff1f3","#eff1f3","#eff1f3","#33a186","#C8BEAE","#eff1f3","#eff1f3","#eff1f3", "#eff1f3"]' class="apex-chart"></div>
                                        </div>
                                    </div>
                                    <div class="col-xl-4">
                                        <div class="">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-center mt-4">
                                    <canvas class="mx-auto" id="sales-category" height="281" data-colors='["#C8BEAE","#51af98", "#4bafe1", "#B4B4B5", "#f1f3f4"]'></canvas>
                                </div>
                                        ...
                                        <div class="table-responsive px-3" data-simplebar style="max-height: 393px;">
                                            <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><img src="/assets/images/users/<?=auth()->user()->photo?>" class="avatar-sm rounded-circle " alt="..."></td>
                                                        <td>
                                                            <h6 class="font-size-15 mb-1">Sonya Henshaw</h6>
