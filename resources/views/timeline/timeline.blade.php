                                                    ...
                                                    <a href="#">
                                                        <div class="d-flex align-items-start">
                                                            ...
                                                            <div class="flex-grow-1 overflow-hidden">
                                                                ...
                                                                <p class="text-truncate mb-0 text-body">I've finished it!
                                                                    See you so</p>
                                                            </div>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <div class="d-flex align-items-start">
                                                            ...
                                                            <div class="flex-grow-1 overflow-hidden">
                                                                <h5 class="text-truncate font-size-14 mb-1">Bernard Spencer
                                                                </h5>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <div class="d-flex align-items-start">
                                                            ...
                                                            <div class="flex-grow-1 overflow-hidden">
                                                                <h5 class="text-truncate font-size-14 mb-1">Annie Holder
                                                                </h5>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <div class="d-flex align-items-start">
                                                            ...
                                                            <div class="flex-grow-1 overflow-hidden">
                                                                <h5 class="text-truncate font-size-14 mb-1">Vernon Smith
                                                                </h5>
                                                    ...
                                                    <div class="ctext-wrap">
                                                        <div class="ctext-wrap-content">
                                                            <h5 class="font-size-14 conversation-name"><a href="#"
                                                                    class="text-dark">John Howard</a> <span
                                                                    class="d-inline-block font-size-12 text-muted time">10:00
                                                                    AM</span></h5>
                                                            <p class="mb-0">
                                                    ...
                                                    <div class="ctext-wrap">
                                                        <div class="ctext-wrap-content">
                                                            <h5 class="font-size-14 conversation-name"><a href="#"
                                                                    ...
                                                                    class="d-inline-block font-size-12 text-muted time">10:02
                                                                    AM</span></h5>
                                                            <p class="mb-0">
                                                                Good morning everyone !
                                                            </p>
                                            ...
                                            <li>
                                                <div class="conversation-list">
                                                    <div class="ctext-wrap">
                                                        <div class="ctext-wrap-content">
                                                            <h5 class="font-size-14 conversation-name"><a href="#"
                                                                    class="text-dark">Galen Rizo</a> <span
                                                                    class="d-inline-block font-size-12 text-muted time">10:04
                                                                    AM</span></h5>
                                                            <p class="mb-0">
                                                                Hello!
                                                            </p>
                                                ...
                                                <div class="conversation-list">
                                                    <div class="ctext-wrap">
                                                        <div class="ctext-wrap-content">
                                                            <h5 class="font-size-14 conversation-name"><a href="#"
                                                                    class="text-dark">John Howard</a> <span
                                                                    class="d-inline-block font-size-12 text-muted time">10:06
                                                                    AM</span></h5>
                                                            <p class="mb-0">
