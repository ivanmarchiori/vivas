                                            ...
                                            <table class="table align-middle table-nowrap table-centered mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <h5 class="text-truncate font-size-14 mb-1">Black Strap A012
                                                                </h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <h5 class="text-truncate font-size-14 mb-1">Stainless Steel
                                                                    S010</h5>
                                                    ...
                                                    <!-- end tr -->
                                                    <tr>
                                                        <th scope="row" colspan="4" class="border-0 text-end">Total
                                                        </th>
