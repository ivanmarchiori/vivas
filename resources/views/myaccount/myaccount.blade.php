                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-nowrap table-hover mb-0">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <th scope="row">01</th>
                                                                <td><a href="#" class="text-dark">Brand Logo
                                                                        Design</a></td>
                                                                <td>
                                                                    18 Jun, 2020
                                                                </td>
                                                                <td>
                                                                    <span
                                                                        class="badge text-primary bg-primary-subtle font-size-12">Open</span>
                                                                </td>
                                                                <td>
                                                                    <div class="dropdown">
                                                            ...
                                                            <tr>
                                                                <th scope="row">02</th>
                                                                <td><a href="#" class="text-dark">Minible Admin</a>
                                                                </td>
                                                                <td>
                                                                    06 Jun, 2020
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <th scope="row">03</th>
                                                                <td><a href="#" class="text-dark">Chat app Design</a>
                                                                </td>
                                                                <td>
                                                                    28 May, 2020
                                                                </td>
                                                                <td>
                                                                    <span
                                                                        class="badge text-success  bg-success-subtle font-size-12">Complete</span>
                                                                </td>
                                                                <td>
                                                                    <div class="dropdown">
                                                                        <a class="text-muted dropdown-toggle font-size-18 px-2"
                                                            ...
                                                            <tr>
                                                                <th scope="row">04</th>
                                                                <td><a href="#" class="text-dark">Minible
                                                                        Landing</a></td>
                                                                <td>
                                                                    13 May, 2020
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <th scope="row">05</th>
                                                                <td><a href="#" class="text-dark">Authentication
                                                                        Pages</a></td>
                                                                <td>
                                                                    06 May, 2020
                                                                </td>
                                                ...
                                                <table class="table table-nowrap table-centered">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#" class="fw-bold text-dark">Ecommerce
                                                                    Product Detail</a>
                                                            </td>
                                                            ...
                                                            <td style="width: 160px;"><span
                                                                    class="badge text-primary bg-primary-subtle font-size-12">Active</span>
                                                            </td>
                                                ...
                                                <table class="table table-nowrap table-centered">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#" class="fw-bold text-dark">Chat app
                                                                    Page</a>
                                                            </td>
                                                            ...
                                                            <td>-</td>
                                                            <td style="width: 160px;"><span
                                                                    class="badge text-secondary  bg-secondary-subtle font-size-12">Waiting</span>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#" class="fw-bold text-dark">Email
                                                                    Pages</a>
                                                            </td>
                                                            ...
                                                            <td>04 June, 2020</td>
                                                            <td><span
                                                                    class="badge text-primary bg-primary-subtle font-size-12">Approved</span>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#" class="fw-bold text-dark">Contacts
                                                                    Profile Page</a>
                                                            </td>
                                                            <td>
                                                                <p class="ml-4 text-muted mb-0">
                                                ...
                                                <table class="table table-nowrap table-centered">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#" class="fw-bold text-dark">UI
                                                                    Elements</a>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#" class="fw-bold text-dark">Authentication
                                                                    Pages</a>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#" class="fw-bold text-dark">Admin
                                                                    Layout</a>
                                                            </td>
                                        ...
                                        <div>
                                            <div data-simplebar style="max-height: 430px;">
                                                        ...
                                                        <div class="d-flex align-items-start mt-4">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <h5 class="font-size-15 mb-1">Shanon Marvin <small
                                                                        class="text-muted float-end">1 hr ago</small></h5>
                                                                <p class="text-muted">It will be as simple as in fact, it
                                                                    will be Occidental. To it will seem like simplified .
                                                                </p>
                                                ...
                                                <div class="d-flex align-items-start border-bottom py-4">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img class="rounded-circle avatar-sm"
                                                            src="/assets/images/users/avatar-5.jpg" alt="avatar-5 images">
                                                    </div>
                                                ...
                                                <div class="d-flex align-items-start border-bottom py-4">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img class="rounded-circle avatar-sm"
                                                            src="/assets/images/users/avatar-7.jpg" alt="avatar-7 images">
                                                    </div>
