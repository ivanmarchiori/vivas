                                            ...
                                            <div class="row">
                                                <div class="col-md-4 col-6">
                                                    <h5 class="font-size-16 mb-1 text-truncate"><a href="#"
                                                            class="text-dark"><?php echo $language['SetupReasons']?></a></h5>
                                                        ...
                                                        <div class="col-auto">
                                                            <button type="submit"
                                                                class="btn btn-primary chat-send w-md waves-effect waves-light"><span
                                                                    class="d-none d-sm-inline-block me-2">Model to <?php echo $language['SetupReasons']?></span> <i
                                                                    class="mdi mdi-plus float-end"></i></button>
                                                        </div>
                                                        <div class="col-auto">
                                                            <button type="submit"
                                                                class="btn btn-primary chat-send w-md waves-effect waves-light"><span
                                                                    class="d-none d-sm-inline-block me-2">Add <?php echo $language['SetupReasons']?></span> <i
                                                                    class="mdi mdi-plus float-end"></i></button>
                                                        </div>
                                                    </div>
                                                </div>
