                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mt-5">
                                        <div class="col-xl-3 col-sm-5 mx-auto">
                                            <div>
                                                <img src="/assets/images/faqs-img.png" alt=""
                                        ...
                                        <div class="col-xl-8">
                                            <div id="faqs-accordion" class="custom-accordion mt-5 mt-xl-0">
                                                <div class="card border shadow-none">
                                                    <a href="#faqs-gen-ques-collapse" class ="text-dark"
                                                        data-bs-toggle="collapse" aria-haspopup="true" aria-expanded="true"
                                                        ...
                                                        <div class="bg-light p-3">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="flex-grow-1 overflow-hidden">
                                                                    ...
                                                                    <p class="text-muted text-truncate mb-0">General
                                                                        Questions</p>
                                                                </div>
                                                                <div class="flex-shrink-0">
                                                                    <i
                                                                        class="mdi mdi-chevron-up accor-down-icon font-size-16"></i>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </a>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div>
                                                                        <div class="d-flex align-items-start mt-4">
                                                                            <div class="flex-shrink-0 me-3">
                                                                                <h5 class="text-primary font-size-16">01.
                                                                                </h5>
                                                                            </div>

                                                                            <div class="flex-grow-1">
                                                                                <h5 class="font-size-16">What is Lorem Ipsum
                                                                                    ?</h5>
                                                                                <p class="text-muted">If several languages
                                                                                    coalesce, the grammar of the resulting
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div>
                                                                        <div class="d-flex align-items-start mt-4">
                                                                            <div class="flex-shrink-0 me-3">
                                                                                <h5 class="text-primary font-size-16">02.
                                                                                </h5>
                                                                            </div>

                                                                            <div class="flex-grow-1">
                                                                                <h5 class="font-size-16">Where does it come
                                                                                    from ?</h5>
                                                                                <p class="text-muted">Everyone realizes why
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div>
                                                                        <div class="d-flex align-items-start mt-4">
                                                                            <div class="flex-shrink-0 me-3">
                                                                                <h5 class="text-primary font-size-16">03.
                                                                                </h5>
                                                                            </div>

                                                                            <div class="flex-grow-1">
                                                                                <h5 class="font-size-16">Why do we use it ?
                                                                                </h5>
                                                                                <p class="text-muted">Their separate
                                                        ...
                                                        <div class="bg-light p-3">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="flex-grow-1 overflow-hidden">
                                                                    ...
                                                                    <p class="text-muted text-truncate mb-0">Privacy Policy
                                                                        Questions</p>
                                                                </div>
                                                                <div class="flex-shrink-0">
                                                                    <i
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div>
                                                                        <div class="d-flex align-items-start mt-4">
                                                                            ...
                                                                            <div class="flex-grow-1">
                                                                                <h5 class="font-size-16">Where can I get
                                                                                    some ?</h5>
                                                                                <p class="text-muted">If several languages
                                                                                    coalesce, the grammar of the resulting
                                                                                    language is more simple</p>
                                                        ...
                                                        <div class="bg-light p-3">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="flex-grow-1 overflow-hidden">
                                                                    ...
                                                                    <p class="text-muted text-truncate mb-0">Pricing &
                                                                        Plans Questions</p>
                                                                </div>
                                                                <div class="flex-shrink-0">
                                                                    <i
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div>
                                                                        <div class="d-flex align-items-start mt-4">
                                                                            ...
                                                                            <div class="flex-grow-1">
                                                                                <h5 class="font-size-16">What is Lorem
                                                                                    Ipsum ?</h5>
                                                                                <p class="text-muted">If several languages
                                                                                    coalesce, the grammar of the resulting
                                                                                    language is more simple</p>
