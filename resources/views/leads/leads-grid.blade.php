                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-1 ms-3">
                                            <h5 class="font-size-16 mb-1"><a href="#" class="text-dark">Phyllis
                                                    Gatlin</a></h5>
                                            <p class="text-muted mb-0">Full Stack Developer</p>
                                        </div>
                                    </div>
                                    <p class="mt-3 text-muted">Curabitur non magna lobortis est tempus gravida ornare libero
                                        sed diam sed fringilla est.</p>

                                    <div class="pt-1">
                                        <button type="button" class="btn btn-soft-primary btn-sm text-truncate"><i
                                                class="bx bx-user me-1"></i> Contact</button>
                                        <a href="/contact/profile" class="btn btn-primary btn-sm text-truncate ms-2"><i
                                                class="bx bx-message-square-dots me-1"></i> Profile</a>
                                    </div>
                                </div>
                            </div>
                            <!-- end card -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-1 ms-3">
                                            <h5 class="font-size-16 mb-1"><a href="#" class="text-dark">James Nix</a>
                                            </h5>
                                            <p class="text-muted mb-0">Full Stack Developer</p>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-1 ms-3">
                                            <h5 class="font-size-16 mb-1"><a href="#" class="text-dark">Darlene
                                                    Smith</a></h5>
                                            <p class="text-muted mb-0">UI/UX Designer</p>
                                        </div>
                                    </div>
                                    <p class="mt-3 text-muted">Curabitur non magna lobortis est tempus gravida ornare
                                        libero sed diam sed fringilla est.</p>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-1 ms-3">
                                            <h5 class="font-size-16 mb-1"><a href="#" class="text-dark">William
                                                    Swift</a></h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-1 ms-3">
                                            <h5 class="font-size-16 mb-1"><a href="#" class="text-dark">Kevin
                                                    West</a></h5>
                                            <p class="text-muted mb-0">Full Stack Developer</p>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-1 ms-3">
                                            <h5 class="font-size-16 mb-1"><a href="#" class="text-dark">Tommy
                                                    Hayes</a></h5>
                                            <p class="text-muted mb-0">Backend Developer</p>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-1 ms-3">
                                            <h5 class="font-size-16 mb-1"><a href="#" class="text-dark">Diana
                                                    Owens</a></h5>
                                            <p class="text-muted mb-0">UI/UX Designer</p>
                                        </div>
                                    </div>
