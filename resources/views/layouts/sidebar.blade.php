        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="/products" data-key="t-product-detail"><?php echo $language["Products"]; ?></a></li>
                        <li><a href="/products/details/1" data-key="t-product-detail"><?php echo $language["Product_Detail"]; ?></a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="/notes" data-key="t-inbox"><?php echo $language["Inbox"]; ?></a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="/invoice/detail/1" data-key="t-invoice-detail"><?php echo $language["Invoice_Detail"]; ?></a></li>
                    </ul>
                </li>
