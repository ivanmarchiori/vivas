            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="page-recoverpw.php" data-key="t-recover-password"><?php echo $language['Recover_Password']; ?></a></li>
                        <li><a href="/block" data-key="t-lock-screen"><?php echo $language['Lock_Screen']; ?></a></li>
                        <li><a href="/logout" data-key="t-logout"><?php echo $language['Log_Out']; ?></a></li>
                        ...
                        <li><a href="auth-email-verification.php"
                                data-key="t-email-verification"><?php echo $language['Email_Verification']; ?></a></li>
                        <li><a href="auth-two-step-verification.php"
                                data-key="t-two-step-verification"><?php echo $language['Two_Step_Verification']; ?></a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="ui-tabs-accordions.php" data-key="t-tabs-accordions"><?php echo $language['Tabs_n_Accordions']; ?></a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="extended-notifications.php" data-key="t-notifications"><?php echo $language['Notifications']; ?></a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        ...
                        <li><a href="javascript: void(0);" class="has-arrow"
                            ...
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="javascript: void(0);" data-key="t-level-2.1"><?php echo $language['Level_2_1']; ?></a>
                                </li>
                                <li><a href="javascript: void(0);" data-key="t-level-2.2"><?php echo $language['Level_2_2']; ?></a>
                                </li>
                            </ul>
                        </li>
                    </ul>
