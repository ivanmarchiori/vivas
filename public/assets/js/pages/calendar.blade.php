...
<div id="layout-wrapper">
    ...
    <div class="main-content">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="external-events">
                                            ...
                                            <div class="external-event fc-event bg-primary" data-class="bg-primary">
                                                <i class="mdi mdi-checkbox-blank-circle font-size-11 me-2"></i>Planning
                                            </div>
                                        </div>
        ...
        <?php include resource_path('views/layouts/<?php include resource_path('views/layouts/footer.blade.php');?>.php');?>
    </div>
    <!-- end main content-->
